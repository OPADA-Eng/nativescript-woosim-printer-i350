...
export class BluetoothPermissions {
  ...
  public coarseLocationPermissionGranted() {
    ...
    if (!hasPermission) {
      ...
      hasPermission =
        ...
        (this.androidSupport.content.ContextCompat as any).checkSelfPermission(ctx, android.Manifest.permission.ACCESS_COARSE_LOCATION);
    }
  ...
  public requestCoarseLocationPermission(callback?: () => void): Promise<boolean> {
    return new Promise((resolve, reject) => {
      ...
      (this.androidSupport.app.ActivityCompat as any).requestPermissions(
        this._getActivity(),
